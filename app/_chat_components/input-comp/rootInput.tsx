  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="fixed bottom-2 w-full max-w-2xl">
        <form className="relative m-auto flex items-center gap-5 overflow-y-auto rounded-[26px] bg-[#F4F4F4] dark:bg-[#2F2F2F] px-3 text-base md:px-5 lg:px-1 xl:px-5">
          <Textarea
            className="min-w-0 flex-1 resize-none overflow-y-auto dark:bg-[#2F2F2F] p-2 text-white bg-[#F4F4F4] outline-none focus:ring-0"
